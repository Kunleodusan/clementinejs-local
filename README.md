...
- **Free Code Camp (FCC) - Modified** (this version): A modified version of the **Free Code Camp (FCC)** boilerplate that uses **passport-local** for authentication intended for use with the [Free Code Camp](http://freecodecamp.com/) curriculum.
...
```bash
$ git clone https://github.com/aanaedu/clementinejs-local.git your-project
```
...
```
MONGO_URI=mongodb://localhost:27017/clementinejs-local
PORT=8080
